% Levanto archivos
M = csvread('goloso_eu_pares.csv');
M = M(:, [1,2]); % N MEAN_TIME
goloso_n = M(:,1);
goloso_t = M(:,2);

M = csvread('backtracking_eu_pares.csv');
...
title('Tiempo de ejecución de grafos eulerianos con ciclos pares según cantidad de nodos.')
